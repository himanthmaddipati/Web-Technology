package org.example.osprojclone_3_newfx.GUI_Files.viewer_GUI;
...
import org.example.osprojclone_3_newfx.GUI_Files.module_GUI.IProcess;
import org.example.osprojclone_3_newfx.GUI_Files.module_GUI.ProcessData;
	...
	private IntervalCategoryDataset getCategoryDataset() {
		...
		for(IProcess prc : processList) {
			...
			for(ProcessData prcData : subProcessList) {
				subTasks[key] = new Task("Process" + Integer.toString(key), prcData.GetStart(), prcData.GetEnd());
				key++;
			}
