...
public class PickAlgo {
	...
	public PickAlgo(int algorithmType, Queue<java.lang.Process> jobQueue, int degreeOfMP, double alpha, int contix) {
		if (algorithmType == 0)
			obj0 = new FirstComeFirstServed(jobQueue, new LinkedList<java.lang.Process>(), new LinkedList<java.lang.Process>(), degreeOfMP,
					contix);
		else if (algorithmType == 1)
			obj1 = new ShortestJobFirst(jobQueue, new LinkedList<java.lang.Process>(), new LinkedList<java.lang.Process>(), degreeOfMP,
					contix);
		else if (algorithmType == 2)
			obj2 = new RoundRobin(jobQueue, new LinkedList<java.lang.Process>(), new LinkedList<java.lang.Process>(), degreeOfMP, contix);
		else if (algorithmType == 3)
			obj3 = new ExponentialAveraging(jobQueue, new LinkedList<java.lang.Process>(), new LinkedList<java.lang.Process>(), degreeOfMP,
					alpha, contix);
		else if (algorithmType == 4)
			obj4 = new Priority(jobQueue, new LinkedList<java.lang.Process>(), new LinkedList<java.lang.Process>(), degreeOfMP, contix);
		else if (algorithmType == 5)
			obj5 = new ShortestRemainingTimeFirst(jobQueue, new LinkedList<java.lang.Process>(), new LinkedList<java.lang.Process>(),
					degreeOfMP, contix);
		else
			System.out.println("Out of bounds");
	}

	public LinkedList<java.lang.Process> getInitialJobQueue(int algorithmType) {
		if (algorithmType == 0)
	...
	public Queue<java.lang.Process> getJobQueue(int algorithmType) {
		if (algorithmType == 0)
	...
	public LinkedList<java.lang.Process> getDeviceList(int algorithmType) {
		if (algorithmType == 0)
	...
	public Queue<java.lang.Process> getReadyQueue(int algorithmType) {
		if (algorithmType == 0)
	...
	public java.lang.Process getRunningState(int algorithmType) {
		if (algorithmType == 0)
