...
public class ShortestRemainingTimeFirst {
	public Queue<java.lang.Process> jobQueue;
	public LinkedList<java.lang.Process> initJobQueue;
	public Queue<java.lang.Process> readyQueue;
	// the devices are list because we have infinitely many IOs
	public LinkedList<java.lang.Process> deviceList;
	public int degreeOfMP;
	int contix;
	public LinkedList<java.lang.Process> tempList;
	...
	public java.lang.Process runningState;
	...
	public java.lang.Process prevRunningState;
	boolean flaga = true;
	public ShortestRemainingTimeFirst(Queue<java.lang.Process> jobQueue, Queue<java.lang.Process> readyQueue,
                                      LinkedList<java.lang.Process> deviceList, int degreeOfMP, int contix) {
		super();
		this.contix = contix;
		...
		tempList = new LinkedList<java.lang.Process>();
		for (java.lang.Process p : jobQueue) {
			tempList.add(p);
		}
	...
	public String[][] iterateSRJF() {
		...
		for (java.lang.Process p : readyQueue) {
			p.timeInTheSystem++;
			p.timeInTheReadyQueue++;
			totalTimeInTheSystem++;
			totalTimeInTheReadyQueue++;
		}
		for (java.lang.Process p : deviceList) {
			p.timeInTheSystem++;
			totalTimeInTheSystem++;
		}
...
//						"all the processes in the whole SYSTEM are  waiting! Or no processes have arrived yet Or both two");
		...
		if (runningState != null) {
			...
			//System.out.println("The Total percentage for process(" + runningState.pID + ") is = "
//					+ (runningState.spentTime / (runningState.overallTime * 1.0) * 100) + "%");
//
//			//System.out.println("The Current burst percentage for process(" + runningState.pID + ") is = "
...
//					+ (prevRunningState != null ? "pID(" + prevRunningState.pID + ")" : "No process can run");
		...
		//System.out.println((currentTime - timeRunningStateIsNotWorking) / (currentTime * 1.0) + ""); // cpu
																										// utilization
		//System.out.println("" + (1000 * numberOfProcessesDoneSoFar) / (currentTime * 1.0)); // throughput
