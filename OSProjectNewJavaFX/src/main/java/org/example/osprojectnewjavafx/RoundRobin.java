...
public class RoundRobin {
	...
	public int timeQCounter;
	boolean flaga = true;

	public RoundRobin(Queue<java.lang.Process> jobQueue, Queue<java.lang.Process> readyQueue, LinkedList<java.lang.Process> deviceList,
	...
	public String[][] iterateRR(int timeQuantum) {
		...
		if (runningState != null && runningState.getCurrentBurst().timeNeeded == 0) {
			...
			// System.out.println("some changes will happen :D :D:D :D:D:D:D:DD llil
			// rawwr");
			prevRunningState = runningState;
			displayInfo = true;
			displayInfo2 = true;
		...
		for (int i = 0; i < deviceList.size(); i++) {
			...
			System.out.println(deviceList.get(i).content[deviceList.get(i).currentBurst].type);
