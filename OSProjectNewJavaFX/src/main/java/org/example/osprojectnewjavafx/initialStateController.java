...
import org.example.osprojectnewjavafx.Process;
import org.example.osprojectnewjavafx.initialStateController.Data;
...
public class initialStateController implements Initializable {
	...
	@FXML
	private VBox vbox;
	static ArrayList<java.lang.Process> array = new ArrayList<>();
	@FXML
	...
	public void create() {
		...
		p.setCellValueFactory(new Callback<CellDataFeatures<Data,String>, ObservableValue<String>>() {
			@Override
		...
		a.setCellValueFactory(new Callback<CellDataFeatures<Data,String>, ObservableValue<String>>() {
		...
		prio.setCellValueFactory(new Callback<CellDataFeatures<Data,String>, ObservableValue<String>>() {
		...
		LinkedList<java.lang.Process> temp = MainSceneController.object.getInitialJobQueue(MainSceneController.algorithmType);
		PriorityQueue<java.lang.Process> temp2;
		temp2 = new PriorityQueue<java.lang.Process>(MainSceneController._processesNumber, new SortByArraivalTime());
		for (java.lang.Process p1 : temp) {
			try {
				temp2.add((java.lang.Process) p1.clone());
		...
		int index = 0;
		while(!temp2.isEmpty()) {
			java.lang.Process t = temp2.poll();
